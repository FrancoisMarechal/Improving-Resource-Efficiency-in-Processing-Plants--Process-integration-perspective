...
The process heat transfer requirement for a real chemical site is defined for each process unit operation using multi-level data extraction approach of  
        \begin{figure}[h]
        \begin{center}
