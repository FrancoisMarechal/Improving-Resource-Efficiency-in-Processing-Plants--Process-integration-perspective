...
\begin{figure*}[!ht]
 \centering
  \begin{tabular}{c}
 	\subfloat[Process unit]{\includegraphics[width=60mm]{figures/HeatIntegration/triplereptop.pdf}} \\
 	\subfloat[Triple representation]{\includegraphics[width=146mm]{figures/HeatIntegration/triplerepbot.pdf}} 	
\end{tabular}
...
\vspace{5mm}
\begin{center}
\includegraphics[width=125mm]{figures/HeatIntegration/integrationAnalysis.pdf}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=146mm]{figures/HeatIntegration/fig2ab.pdf}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=146mm]{figures/HeatIntegration/fig3ab.pdf}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=80mm]{figures/HeatIntegration/fig4.pdf}
...
\end{figure}
 ...
 Summing up the possible energy savings for the three process systems by SPI shows an additional heat recovery potential of 23\% unit. Fig. \ref{fig3:new} gives the detail of SPI analysis of the three process systems.
...
\vspace{5mm}
\begin{center}
\includegraphics[width=146mm]{figures/HeatIntegration/fig5.pdf}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=71mm]{figures/HeatIntegration/figpressa.pdf}
\includegraphics[width=70mm]{figures/HeatIntegration/figpressb.pdf}
...
\end{figure}
 ...
 \begin{figure}[!ht]
\centering
\includegraphics[width=71mm]{figures/HeatIntegration/figmvra.pdf}
\includegraphics[width=70mm]{figures/HeatIntegration/figmvrb.pdf}
...
\end{figure}
 ...
 \begin{figure}[!ht]
 \begin{center}
 \includegraphics[width=70mm]{figures/HeatIntegration/figutilitya.pdf}
 \includegraphics[width=70mm]{figures/HeatIntegration/figutilityb.pdf}
 \includegraphics[width=70mm]{figures/HeatIntegration/figutilityc.pdf}
